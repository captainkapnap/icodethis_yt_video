...
function ICodeThis() {
   ...
   <path d="M12 3l0 .01"></path>
            ...
            <ul>
                ...
                <li><a className="cursor-default block group relative w-12 h-12 my-2" href="#">
                    <span className="flex gap-2 hover:bg-slate-800 absolute rounded-full p-3 group-hover:pr-16 transition">
