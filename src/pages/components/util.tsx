...
function ICodeThis() {
    ...
    return (
      <div className="flex">
        <nav className="bg-slate-900 text-white rounded-xl shadow-2xl p-6">
        <svg xmlns="http://www.w3.org/2000/svg" class="mb-6" width="48" height="48" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   ...
   <path d="M12 3l0 .01"></path>
            ...
            <ul>
                <li><a className="flex gap-2 bg-slate-800 rounded-full my-2 p-3 justify-center " href="#">
   ...
   <path d="M9 21v-4a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v4"></path>
                    ...
                    <span className="hidden group-hover:block">Store</span>
                    </a></li>
                <li><a className="flex gap-2 bg-slate-800 rounded-full my-2 p-3 justify-center" href="#">
   ...
   <path d="M12 15l0 6"></path>
                    ...
                    <span className="hidden group-hover:block">Design</span>
                    </a></li>
                <li><a className="flex gap-2 bg-slate-800 rounded-full my-2 p-3 justify-center" href="#">
   ...
   <path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path>
            ...
            <div className="flex mt-10">
                ...
                <div className="ml-4">
                    <p className="text-lg font-semibold hidden">Kris Kaps</p>
                    <small className="text-slate-300 hidden">kris@kaperi.com</small>
                </div>
            </div>
        </nav>
